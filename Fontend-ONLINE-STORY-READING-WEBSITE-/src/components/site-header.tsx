    ...
    <header className="sticky top-0 z-50 w-full border-b border-border bg-card/95 backdrop-blur supports-[backdrop-filter]:bg-card/80">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 lg:px-8">
        <Link to="/" className="flex items-center gap-3 group">
          ...
          <div className="flex flex-col">
            <span className="font-black text-xl text-slate-900 tracking-tight leading-none uppercase">
              Alex<span className="text-indigo-600">Store</span>
            </span>
        ...
        <nav className="hidden items-center gap-1 lg:flex">
          ...
          <Link to="/support"
            className="rounded-md px-3 py-2 text-sm font-medium text-emerald-600 transition-colors hover:bg-emerald-50 flex items-center gap-1.5"
          >
        ...
        <div className="border-t border-border lg:hidden">
          <nav className="flex flex-col px-4 py-2">
            ...
            <Link to="/support"
              ...
              onClick={() => setIsMenuOpen(false)}
            >
              <Headphones className="mr-2 h-4 w-4" /> Hỗ trợ
            </Link>
            <div className="py-1">
